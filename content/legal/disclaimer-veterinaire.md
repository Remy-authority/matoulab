...
> Rédigé le 2026-07-11 pour **matoulab.fr**. À afficher sur **toute page santé / MED** (contenu YMYL — santé animale). Cohérent avec le composant `Disclaimer.astro` (livrable 3).
...
- matoulab.fr décline toute responsabilité quant à l'usage fait de ces informations, dans les limites permises par la loi.
