...
> Rédigé le 2026-07-11 pour **matoulab.fr**. Reflète le choix de stack : analytics = **Cloudflare Web Analytics (cookieless, sans consentement)** ; MAIS les liens d'affiliation et tiers (régie display) peuvent déposer des traceurs → à divulguer et, le cas échéant, à soumettre au consentement.

# Politique de confidentialité — matoulab.fr
...
- **Contact données personnelles :** `[[À COMPLÉTER : e-mail dédié, ex. privacy@matoulab.fr]]`
